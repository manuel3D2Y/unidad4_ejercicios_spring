...
public class PersonaDaoImpl implements PersonaDao {
	...
	public void setDataSource(DataSource dataSource) {
		...
		// posible // La diferencia es el manejo de parámetros por indice o por
		// nombre
	...
	// private static final String SQL_INSERT_PERSONA = "Insert into persona
	// (username, password, fullname, email,update_by_email) values (?, ?, ?, ?,
	// ?)"; // Parametros por nombre
	private static final String SQL_UPDATE_PERSONA = "UPDATE PERSONA setnombre = :nombre, ape_paterno = :apePaterno, ape_materno =:apeMaterno, email = :email WHERE id_persona = :idPersona";
	private static final String SQL_DELETE_PERSONA = "DELETE FROM PERSONA WHERE id_persona = :idPersona";
	private static final String SQL_SELECT_PERSONA = "SELECT id_persona, nombre, ape_paterno,ape_materno, email FROM PERSONA"; // Parametros
																																// por
																																// indice
																																// private
	static final String SQL_SELECT_PERSONA_BY_ID = SQL_SELECT_PERSONA + " WHERE id_persona = ?";
	...
	public int contadorPersonasPorNombre(Persona persona) {
		...
		// objeto persona // los atributos que coincidan con el nombre de los
		// parametros por nombre del query // seran utilizados y proporcionados
		// como atributos al query
	...
	public Persona getPersonaByEmail(Persona persona) {
	  ...
	  //return
		this.namedParameterJdbcTemplate.queryForObject(sql, namedParameters,new PersonaRowMapper());
